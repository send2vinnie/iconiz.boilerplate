...
using Iconiz.Boilerplate.Tests.TestDatas;
...
namespace Iconiz.Boilerplate.Tests
{
    ...
    /// Provides methods to easily work with <see cref="BoilerplateDbContext"/>.
    /// </summary>
    public abstract class AppTestBase : AbpIntegratedTestBase<BoilerplateTestModule>
    {
