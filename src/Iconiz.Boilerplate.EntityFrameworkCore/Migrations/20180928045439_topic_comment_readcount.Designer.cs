...
namespace Iconiz.Boilerplate.Migrations
{
    ...
    [Migration("20180928045439_topic_comment_readcount")]
    partial class topic_comment_readcount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Iconiz.Boilerplate.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Iconiz.Boilerplate.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Iconiz.Boilerplate.Chat.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Iconiz.Boilerplate.Friendships.Friendship", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Iconiz.Boilerplate.IconizFinance.IconizTopic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("IconizTopic");
                });

            modelBuilder.Entity("Iconiz.Boilerplate.IconizFinance.IconizTopicComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Iconiz.Boilerplate.MultiTenancy.Payments.SubscriptionPayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Iconiz.Boilerplate.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Iconiz.Boilerplate.Storage.BinaryObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Iconiz.Boilerplate.Editions.SubscribableEdition", b =>
                {
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Iconiz.Boilerplate.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Iconiz.Boilerplate.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Iconiz.Boilerplate.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Iconiz.Boilerplate.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Iconiz.Boilerplate.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Iconiz.Boilerplate.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Iconiz.Boilerplate.IconizFinance.IconizTopicComment", b =>
                {
                    b.HasOne("Iconiz.Boilerplate.IconizFinance.IconizTopic", "IconizTopic")
                        .WithMany("IconizTopicComments")
