...
using Iconiz.Boilerplate.Configuration.Host;
using Iconiz.Boilerplate.Editions;
using Iconiz.Boilerplate.Timing;
using Iconiz.Boilerplate.Timing.Dto;
using Iconiz.Boilerplate.Web.Areas.AppAreaName.Models.HostSettings;
...
namespace Iconiz.Boilerplate.Web.Areas.AppAreaName.Controllers
{
    ...
    public class HostSettingsController : BoilerplateControllerBase
    {
