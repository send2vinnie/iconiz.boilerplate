...
using Iconiz.Boilerplate.Web.Areas.AppAreaName.Models.Languages;
...
namespace Iconiz.Boilerplate.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : BoilerplateControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = BoilerplateConsts.LocalizationSourceName;
            }
