...
using Iconiz.Boilerplate.Web.Areas.AppAreaName.Models.SubscriptionManagement;
using Iconiz.Boilerplate.Web.Controllers;
using Iconiz.Boilerplate.Web.Session;
using PaymentViewModel = Iconiz.Boilerplate.Web.Models.Payment.PaymentViewModel;

namespace Iconiz.Boilerplate.Web.Areas.AppAreaName.Controllers
{
    [Area("AppAreaName")]
    [AbpMvcAuthorize(AppPermissions.Pages_Administration_Tenant_SubscriptionManagement)]
    public class SubscriptionManagementController : BoilerplateControllerBase
    {
