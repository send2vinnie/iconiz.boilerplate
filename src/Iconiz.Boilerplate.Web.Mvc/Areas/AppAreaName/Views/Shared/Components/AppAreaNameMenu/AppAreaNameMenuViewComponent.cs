...
using Iconiz.Boilerplate.Web.Theme;
using Iconiz.Boilerplate.Web.Views;

namespace Iconiz.Boilerplate.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameMenu
{
    public class AppAreaNameMenuViewComponent : BoilerplateViewComponent
    {
