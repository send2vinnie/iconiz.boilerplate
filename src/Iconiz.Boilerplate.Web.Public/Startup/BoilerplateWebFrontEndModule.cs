...
namespace Iconiz.Boilerplate.Web.Public.Startup
{
    [DependsOn(
        typeof(BoilerplateWebCoreModule)
    )]
    public class BoilerplateWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public BoilerplateWebFrontEndModule(IHostingEnvironment env, BoilerplateEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BoilerplateWebFrontEndModule).GetAssembly());
        }
    }
}
