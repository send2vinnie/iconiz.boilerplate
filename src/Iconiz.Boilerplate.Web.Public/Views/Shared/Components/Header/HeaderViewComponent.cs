...
using Iconiz.Boilerplate.Web.Public.Startup;
using Iconiz.Boilerplate.Web.Session;

namespace Iconiz.Boilerplate.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : BoilerplateViewComponent
    {
