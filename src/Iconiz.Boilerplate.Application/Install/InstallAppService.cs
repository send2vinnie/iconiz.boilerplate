...
using Iconiz.Boilerplate.Migrations.Seed.Host;
...
namespace Iconiz.Boilerplate.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : BoilerplateAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<BoilerplateDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(BoilerplateConsts.ConnectionStringName).Value.ToString();
        }
