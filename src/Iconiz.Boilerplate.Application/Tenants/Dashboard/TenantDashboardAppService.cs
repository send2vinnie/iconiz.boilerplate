...
using Iconiz.Boilerplate.Tenants.Dashboard.Dto;

namespace Iconiz.Boilerplate.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : BoilerplateAppServiceBase, ITenantDashboardAppService
    {
