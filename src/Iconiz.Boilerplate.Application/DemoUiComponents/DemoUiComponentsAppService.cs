...
using Iconiz.Boilerplate.DemoUiComponents.Dto;

namespace Iconiz.Boilerplate.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : BoilerplateAppServiceBase, IDemoUiComponentsAppService
    {
