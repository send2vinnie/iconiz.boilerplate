...
namespace Iconiz.Boilerplate.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : BoilerplateServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Iconiz.Boilerplate", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
