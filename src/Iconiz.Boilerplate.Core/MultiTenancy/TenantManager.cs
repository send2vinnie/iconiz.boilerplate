...
using Iconiz.Boilerplate.MultiTenancy.Demo;
...
namespace Iconiz.Boilerplate.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(BoilerplateConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
